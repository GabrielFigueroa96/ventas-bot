...
class AdminController extends Controller
{
    ...
    public function guardarConfiguracion(Request $request)
    {
        ...
        $data = [
            ...
            'seguimiento_carrito_activo'    => $request->boolean('seguimiento_carrito_activo'),
            'seguimiento_carrito_horas'     => max(1, (int) $request->input('seguimiento_carrito_horas', 2)),
            'seguimiento_sin_pedido_activo' => $request->boolean('seguimiento_sin_pedido_activo'),
            'seguimiento_sin_pedido_dias'   => max(1, (int) $request->input('seguimiento_sin_pedido_dias', 3)),
            'seguimiento_inactivo_activo'   => $request->boolean('seguimiento_inactivo_activo'),
            'seguimiento_inactivo_dias'     => max(1, (int) $request->input('seguimiento_inactivo_dias', 7)),
