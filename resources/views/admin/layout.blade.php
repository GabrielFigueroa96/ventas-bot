...
@php
    ...
    $nav = [
        ...
        ['route' => 'admin.configuracion', 'label' => 'Bot',          'match' => 'admin.configuracion*','icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17H4a2 2 0 01-2-2V5a2 2 0 012-2h16a2 2 0 012 2v10a2 2 0 01-2 2h-1"/>'],
    ];
@endphp
