...
<div class="space-y-6">
    ...
    <div id="form-panel" class="{{ $editando ? '' : 'hidden' }} bg-white rounded-xl shadow p-5 space-y-4">
        ...
        <form method="POST"
            ...
            <div>
                <label class="block text-xs font-semibold text-gray-600 mb-1">URL de imagen <span class="text-gray-400 font-normal">(opcional)</span></label>
            ...
            <div>
                <label class="block text-xs font-semibold text-gray-600 mb-2">Días de envío <span class="text-gray-400 font-normal">(vacío = todos los días)</span></label>
